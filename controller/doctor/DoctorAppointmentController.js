...
appointment.roomName = `room_${appointmentId}_${Date.now()}`;
    ...
    try {
      ...
      try {
        await twilioClient.video.v1.rooms(appointment.roomName).fetch();
...
exports.DeleteAvailability = async (req, res) => {
  try {
    ...
    const userId = req.user.id;
    console.log(availabilityId, "AVAILABILITY ID");
    ...
    console.log(availability,"DELTE OR NOT");
